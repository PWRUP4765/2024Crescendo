...
public class SwerveConstants {
  ...
  public static final double kFrontLeftCANcoderMagnetOffset = -0.440;
  public static final double kFrontRightCANcoderMagnetOffset = 0.079;
  public static final double kRearLeftCANcoderMagnetOffset = 0.253;
  public static final double kRearRightCANcoderMagnetOffset = 0.097;
  ...
  public static final CANSparkMax.IdleMode kTurnIdleMode =
    CANSparkMax.IdleMode.kBrake;
}
