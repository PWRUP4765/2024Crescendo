...
public class IntakeSubsystem extends SubsystemBase {
  ...
  public void IntakeSubsytem() {
    m_intakeMotor =
      new TalonFX(IntakeConstants.kIntakePort, IntakeConstants.kCanbusAddress);
    m_shooterMotor1 =
      new CANSparkMax(IntakeConstants.kShooterPort1, IsBrushless);
    m_shooterMotor2 =
      new CANSparkMax(IntakeConstants.kShooterPort2, IsBrushless);
