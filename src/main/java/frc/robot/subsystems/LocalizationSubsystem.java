...
public class LocalizationSubsystem {
    ...
    public Pose2d getGyroPosition(){
        return new Pose2d((double) m_gyro.getDisplacementX(), (double) m_gyro.getDisplacementY(), new Rotation2d(m_gyro.getAngle() * ((2* Math.PI) / 360)));
    }
    ...
    public void updatePosition(){
        this.position = new Pose2d(0, 0, new Rotation2d(0));
    }
}
