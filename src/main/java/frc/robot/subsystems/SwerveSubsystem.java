...
import frc.robot.SwerveConstants; // SEAN WAS HERE
...
public class SwerveSubsystem extends SubsystemBase {
    ...
    sb_NAVXPitch,
    sb_NAVXYaw, //yaw appears to be the axis for horizontal rotation, (-180, 180)
    sb_NAVXRoll;
    ...
    */
    ...
    public void joystickDrive(double x, double y, double r) {
        ...
        x = deadband(x, SwerveConstants.kXSpeedDeadband, SwerveConstants.kXSpeedMinValue);
        y = deadband(y, SwerveConstants.kYSpeedDeadband, SwerveConstants.kYSpeedMinValue);
    ...
    public void drive(double x, double y, double r) {
        ...
        double denominator = max(Math.abs(frontLeftSpeed), Math.abs(frontRightSpeed), Math.abs(rearLeftSpeed), Math.abs(rearRightSpeed), 1.0);
        ...
        updateShuffleboardTab(frontLeftSpeed, frontRightSpeed, rearLeftSpeed, rearRightSpeed, frontLeftAngle, frontRightAngle, rearLeftAngle, rearRightAngle);
